var _OAuth_instances, _a, _OAuth_identity, _OAuth_session, _OAuth_credentials, _OAuth_polling_interval, _OAuth_loadCachedCredentials, _OAuth_getUserCode, _OAuth_startPolling, _OAuth_refreshAccessToken, _OAuth_getClientIdentity;
...
class OAuth {
    ...
    cacheCredentials() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield ((_b = __classPrivateFieldGet(this, _OAuth_session, "f").cache) === null || _b === void 0 ? void 0 : _b.set('youtubei_oauth_credentials', data.buffer));
        });
    }
    removeCache() {
        return __awaiter(this, void 0, void 0, function* () {
            var _b;
            yield ((_b = __classPrivateFieldGet(this, _OAuth_session, "f").cache) === null || _b === void 0 ? void 0 : _b.remove('youtubei_oauth_credentials'));
        });
    }
    /**
...
_a = OAuth, _OAuth_identity = new WeakMap(), _OAuth_session = new WeakMap(), _OAuth_credentials = new WeakMap(), _OAuth_polling_interval = new WeakMap(), _OAuth_instances = new WeakSet(), _OAuth_loadCachedCredentials = function _OAuth_loadCachedCredentials() {
    return __awaiter(this, void 0, void 0, function* () {
        var _b;
        const data = yield ((_b = __classPrivateFieldGet(this, _OAuth_session, "f").cache) === null || _b === void 0 ? void 0 : _b.get('youtubei_oauth_credentials'));
        if (!data)
            return false;
    ...
    const poller = setInterval(() => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            __classPrivateFieldSet(this, _OAuth_credentials, {
                ...
                client_id: (_b = __classPrivateFieldGet(this, _OAuth_identity, "f")) === null || _b === void 0 ? void 0 : _b.client_id,
                client_secret: (_c = __classPrivateFieldGet(this, _OAuth_identity, "f")) === null || _c === void 0 ? void 0 : _c.client_secret,
    ...
    return __awaiter(this, void 0, void 0, function* () {
        var _b, _c, _d;
        if (((_b = __classPrivateFieldGet(this, _OAuth_credentials, "f")) === null || _b === void 0 ? void 0 : _b.client_id) && ((_c = this.credentials) === null || _c === void 0 ? void 0 : _c.client_secret)) {
            Log.info(_a.TAG, 'Using custom OAuth2 credentials.\n');
            return {
        ...
        const url_body = (_d = Constants.OAUTH.REGEX.AUTH_SCRIPT.exec(response_data)) === null || _d === void 0 ? void 0 : _d[1];
        if (!url_body)
            throw new OAuthError('Could not obtain script url.', { status: 'FAILED' });
        Log.info(_a.TAG, `Got YouTubeTV script URL (${url_body})`);
        ...
        Log.info(_a.TAG, 'OAuth2 credentials retrieved.\n', groups);
        return groups;
    });
};
OAuth.TAG = 'OAuth';
